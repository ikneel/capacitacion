...
public class PersonasWs {
	...
	@PostMapping("buscarCiudadCp")
	public Respuesta buscarCiudadCp(@RequestBody Map<String, String> requestBody) {
		String ciudad = requestBody.get("ciudad");
		String codigoPostal = requestBody.get("codigoPostal");
		return service.buscarCiudadCp(ciudad, codigoPostal);
	}
	
	
	@PostMapping("buscarApellidos")
	public Respuesta buscarApellidos(@RequestBody Map<String, String> requestBody) {
		String apellidop = requestBody.get("apellidoPaterno");
		String apellidom = requestBody.get("apellidoMaterno");
		return service.buscarApellidos(apellidop, apellidom);
	}
}
